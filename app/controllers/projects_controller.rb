class ProjectsController < ApplicationController
  ...
  def projectdetails
    ...
    @project_todos = Todo.where("todo_project = ? AND user_id = ? AND latestrecur=true", params[:project],session[:user_id]).order("todo_complete ASC, todo_deadline ASC, todo_item ASC")
    @new_todo = Todo.new
