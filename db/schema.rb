...
ActiveRecord::Schema.define(version: 20150107112254) do
  ...
  create_table "todos", force: :cascade do |t|
    ...
    t.decimal  "todo_timerequired",                precision: 10
    t.boolean  "todo_recurring",     limit: 1
    t.string   "todo_frequency",     limit: 255
    t.decimal  "todo_status",                      precision: 10
    t.decimal  "todo_timeremaining",               precision: 10
    t.integer  "todo_ranking",       limit: 4
